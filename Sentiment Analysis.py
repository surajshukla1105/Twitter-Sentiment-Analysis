...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        # You can get this from twitter dev app
        consumer_key = os.environ['CONSUMER_KEY'] #Your consumer_key Key 
        consumer_secret = os.environ['CONSUMER_SECRET'] #
        access_token = os.environ['ACCESS_TOKEN']  # Your Access token
        ...
        try:
            ...
            self.tweet_count_max = 100  # Because of limit set by twitter
        except:
